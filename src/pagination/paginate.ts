...
const FIRST_PAGE_BASE_RESERVE = 40;
const WORD_TABLE_REFLOW_RESERVE = 40;
const FIRST_PORTRAIT_PAGE_LIMIT = Math.floor(
  PORTRAIT_CONTENT_HEIGHT - FIRST_PAGE_BASE_RESERVE - WORD_TABLE_REFLOW_RESERVE,
);
